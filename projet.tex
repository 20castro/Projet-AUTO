...
\fbox{
	\begin{minipage}{0.96\textwidth}
		On prend enfin la condition intiale $X = \bar X$ correspondant au point d'équilibre associé à $\bar x = 0$
		et $x_r = 0,4 m$ de sorte que la bille parcoure $40 cm$.
	\end{minipage}
}
